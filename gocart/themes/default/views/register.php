...
include('header.php'); ?>
<?php
$company	= array('id'=>'bill_company', 'class'=>'col-lg-6', 'name'=>'company', 'value'=> set_value('company'));
$first		= array('id'=>'bill_firstname', 'class'=>'col-lg-3', 'name'=>'firstname', 'value'=> set_value('firstname'));
$last		= array('id'=>'bill_lastname', 'class'=>'col-lg-3', 'name'=>'lastname', 'value'=> set_value('lastname'));
$email		= array('id'=>'bill_email', 'class'=>'col-lg-3', 'name'=>'email', 'value'=>set_value('email'));
$phone		= array('id'=>'bill_phone', 'class'=>'col-lg-3', 'name'=>'phone', 'value'=> set_value('phone'));
?>
			...
			<fieldset>
				...
				<div class="row">	
					<div class="col-lg-3">
						...
						<input type="password" name="password" value="" class="col-lg-3" autocomplete="off" />
					</div>

					<div class="col-lg-3">
						<label for="account_confirm"><?php echo lang('account_confirm');?></label>
						<input type="password" name="confirm" value="" class="col-lg-3" autocomplete="off" />
					</div>
				</div>
