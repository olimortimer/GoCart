...
<?php
$company	= array('id'=>'company', 'class'=>'col-lg-4', 'name'=>'company', 'value'=> set_value('company', $customer['company']));
$first		= array('id'=>'firstname', 'class'=>'col-lg-2', 'name'=>'firstname', 'value'=> set_value('firstname', $customer['firstname']));
$last		= array('id'=>'lastname', 'class'=>'col-lg-2', 'name'=>'lastname', 'value'=> set_value('lastname', $customer['lastname']));
$email		= array('id'=>'email', 'class'=>'col-lg-2', 'name'=>'email', 'value'=> set_value('email', $customer['email']));
$phone		= array('id'=>'phone', 'class'=>'col-lg-2', 'name'=>'phone', 'value'=> set_value('phone', $customer['phone']));

$password	= array('id'=>'password', 'class'=>'col-lg-2', 'name'=>'password', 'value'=>'');
$confirm	= array('id'=>'confirm', 'class'=>'col-lg-2', 'name'=>'confirm', 'value'=>'');
?>	
	<div class="col-lg-4">
	...
	<div class="col-lg-7 pull-right">
		...
		<div class="row">
			<div class="col-lg-7" id='address_list'>
